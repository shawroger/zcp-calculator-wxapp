...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.zcp = void 0;var ZCP = function () {
  function ZCP(arr) {
    this.result = [];
    if (arr) {
  ...
  ZCP.prototype.traveral = function (size, len) {
    ...
    (function traveral(arr, size, result) {
      var arrConcat = function arrConcat(arr) {
        var result = [];
  ...
  ZCP.prototype.cardToNum = function (val) {
    ...
    if (Object.keys(vaildChars).includes(val.toString())) {
      var returns = 0;
  ...
  ZCP.prototype.filter = function (arr) {
    var isEqual = function isEqual(m, n) {
    ...
    var itemsIsEqual = function itemsIsEqual(m, n) {
    ...
    var arrHasItem = function arrHasItem(m, n) {
      var result = false;
  ...
  ZCP.prototype.sort = function (arr) {
    var sortByLength = function sortByLength(m, n) {
      return n[0].length + n[1].length - m[0].length - m[1].length;
    };
    var sortByFirstLength = function sortByFirstLength(m, n) {
...
var zcp = new ZCP();exports.zcp = zcp;
